...
<h3 align="center">project_title</h3>
  ...
  <p align="center">
    ...
    <br />
    <br />
    <a href="https://github.com/XO30/MT5Scraper">View Demo</a>
    ·
...
2. Clone the repo
   ```sh
   git clone https://github.com/XO30/MT5Scraper.git
   ```
...
See the [open issues](https://github.com/XO30/MT5Scraper/issues) for a full list of proposed features (and known issues).
